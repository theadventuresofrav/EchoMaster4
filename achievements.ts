...
export const ACHIEVEMENTS: Achievement[] = [
    ...
    { id: 'm_mode', icon: '📈', title: 'Motion Master', description: 'Completed "M-Mode Imaging".' },
    ...
    { id: 'escape_room', icon: '🔐', title: 'Escape Artist', description: 'Escaped the Phantom Lab.' },
    { id: 'crossword', icon: '🧩', title: 'Puzzle Pro', description: 'Completed the Physics Crossword.' },
    { id: 'bingo', icon: '🎱', title: 'Bingo Winner', description: 'Won a game of Physics Bingo.' },
];
